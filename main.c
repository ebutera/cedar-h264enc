...
static __s32 GetFrmBufCB(__s32 uParam1,  void *pFrmBufInfo)
{
	...
	encBuf.addrCb = Buf.addrPhyY + CAPTURE_WIDTH * CAPTURE_HEIGHT;
	encBuf.pts_valid = 1;
...
static int CedarvEncInit()
{
	...
	enc_fmt.src_width = CAPTURE_WIDTH;
	enc_fmt.src_height = CAPTURE_HEIGHT;
	enc_fmt.width = CAPTURE_WIDTH;
	enc_fmt.height = CAPTURE_HEIGHT;
	enc_fmt.frame_rate = 10 * 1000;
